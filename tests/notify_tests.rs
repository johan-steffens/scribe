...
fn fire_does_not_panic_with_message() {
    ...
    // fire() should not panic - errors are logged, not propagated.
...
// ── notify module constant tests ─────────────────────────────────────────────

#[test]
fn notification_title_constant_exists() {
    // The notification title is defined as a private constant NOTIFICATION_TITLE.
    // We verify it's used correctly by ensuring fire() doesn't panic.
    // The actual title value "Scribe Reminder" is tested implicitly.
